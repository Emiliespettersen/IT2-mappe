...
class Hovedmeny(Tilstand):
    def __init__(self, vindu_bredde: int, vindu_høyde: int, menyvalg: list) -> None:
        ...
        tittel_font = pygame.freetype.SysFont("serif", 128)
        meny_font = pygame.freetype.SysFont("sans", 64)
    ...
    def tegn(self, vindu:pygame.Surface):
        self.overflate.fill("blue")                 #Fyller hele meny-overflaten med blåfarge
